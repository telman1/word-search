...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Books - name in Armenian and original language';
    displayName: 'Book';
    pluralName: 'books';
    singularName: 'book';
  };
...
export interface ApiLanguageLanguage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Languages for words';
...
export interface ApiRelationRelation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Relations between words';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    from_word: Schema.Attribute.Relation<'manyToOne', 'api::word.word'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    relation_type: Schema.Attribute.Enumeration<
      ['synonym', 'translation', 'stem', 'derived', 'related']
    > &
      Schema.Attribute.Required;
    to_word: Schema.Attribute.Relation<'manyToOne', 'api::word.word'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTranslatorTranslator extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Translators - name in Armenian and original language';
...
export interface ApiWordEntryWordEntry extends Struct.CollectionTypeSchema {
  collectionName: 'word_entries';
  info: {
    description: 'Word units with translations and context';
    displayName: 'Word Entry';
    pluralName: 'word-entries';
    singularName: 'word-entry';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    contextualPassageOriginal: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wordMeaningSense: Schema.Attribute.Text;
    wordUnitEasternArmenian: Schema.Attribute.String &
      Schema.Attribute.Required;
    wordUnitOriginalLanguage: Schema.Attribute.String &
      Schema.Attribute.Required;
    wordUnitWesternArmenian: Schema.Attribute.String;
  };
}
...
export interface ApiWordWord extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Words with linguistic data';
    displayName: 'Word';
    pluralName: 'words';
    singularName: 'word';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::word-entry.word-entry': ApiWordEntryWordEntry;
